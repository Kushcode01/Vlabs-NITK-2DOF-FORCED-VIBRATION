...
function setup() {
    ...
    macFac = new DynamicGraph(50, 300, 100, 220, "X1/Xst", "w/w2",0,100,0,1000,system.mag_func);
    ...
    w= new NumberInput(620, 190, "ω(rad/sec)", 0, 16, 2.8, 0.01, true);
    ...
    button2 = new Button(500, 110, graph)
